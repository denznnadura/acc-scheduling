    ...
    <div class="students-container">
        ...
        <div class="page-header">
            ...
            <div style="display: flex; gap: 8px;">
                <a href="{{ route('schedules.students-pdf', $schedule) }}" target="_blank" class="action-btn"
                    style="background: #dc2626; color: white;">
                    <i class='bx bxs-file-pdf'></i>
                    PDF
                </a>
                <a href="{{ route('schedules.students-excel', $schedule) }}" target="_blank" class="action-btn"
                    style="background: #059669; color: white;">
                    <i class='bx bxs-file'></i>
                    Excel
                </a>
                <a href="{{ route('schedules.students-word', $schedule) }}" target="_blank" class="action-btn"
