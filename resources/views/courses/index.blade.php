...
<x-app-layout>
    ...
    <x-slot name="breadcrumb">Manage Courses</x-slot>

    <style>
        /* Minimalist Courses Page */
        .courses-container {
            max-width: 1400px;
            margin: 0 auto;
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="hours-display">
                                        Lec: {{ $course->lecture_hours }}
                                        @if ($course->lab_hours > 0)
                                            <br>Lab: {{ $course->lab_hours }}
                                        @endif
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span class="badge {{ $course->is_active ? 'active' : 'inactive' }}">
                                        <i class='bx bx-{{ $course->is_active ? 'check-circle' : 'x-circle' }}'></i>
                            ...
                            <tr>
                                <td colspan="8">
                                    <div class="empty-state">
                                        ...
                                        <div class="empty-state-text">Create a new course to get started</div>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
