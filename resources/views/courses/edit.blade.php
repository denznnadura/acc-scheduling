...
<x-app-layout>
    <x-slot name="pageTitle">Edit Course</x-slot>
    <x-slot name="breadcrumb">Courses / Edit</x-slot>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <input type="number" name="lecture_hours" id="lecture_hours"
                            ...
                            value="{{ old('lecture_hours', $course->lecture_hours) }}" min="0" required>
                        @error('lecture_hours')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <input type="number" name="lab_hours" id="lab_hours"
                            ...
                            value="{{ old('lab_hours', $course->lab_hours) }}" min="0" required>
                        @error('lab_hours')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <select name="type" id="type" class="form-select @error('type') is-invalid @enderror"
                            ...
                            <option value="lecture" {{ old('type', $course->type) == 'lecture' ? 'selected' : '' }}>
                                Lecture</option>
                            <option value="laboratory"
                                {{ old('type', $course->type) == 'laboratory' ? 'selected' : '' }}>Laboratory</option>
                            <option value="lecture_lab"
                                {{ old('type', $course->type) == 'lecture_lab' ? 'selected' : '' }}>Lecture & Lab
                            </option>
                        </select>
                        @error('type')
                            <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-12">
                        ...
                        <select name="prerequisite_ids[]" id="prerequisite_ids"
                            ...
                            @foreach ($courses as $prereqCourse)
                                <option value="{{ $prereqCourse->id }}"
                                    {{ in_array($prereqCourse->id, old('prerequisite_ids', $course->prerequisite_ids ?? [])) ? 'selected' : '' }}>
