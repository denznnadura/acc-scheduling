...
<x-app-layout>
    <x-slot name="pageTitle">Create Semester</x-slot>
    <x-slot name="breadcrumb">Semesters / Create</x-slot>
    ...
    <div class="form-container">
        ...
        <div class="form-header">
            ...
            <p>Fill in the semester details</p>
        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select name="name" id="name" class="form-select @error('name') is-invalid @enderror"
                            ...
                            <option value="1st Semester" {{ old('name') == '1st Semester' ? 'selected' : '' }}>1st
                                Semester</option>
                            <option value="2nd Semester" {{ old('name') == '2nd Semester' ? 'selected' : '' }}>2nd
                                Semester</option>
                            <option value="Summer" {{ old('name') == 'Summer' ? 'selected' : '' }}>Summer</option>
                            <option value="Midyear" {{ old('name') == 'Midyear' ? 'selected' : '' }}>Midyear</option>
                        </select>
                        @error('name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="date" name="enrollment_start" id="enrollment_start"
                            ...
                            value="{{ old('enrollment_start') }}" required>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="date" name="enrollment_end" id="enrollment_end"
                            ...
                            value="{{ old('enrollment_end') }}" required>
