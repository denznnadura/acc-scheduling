...
<x-app-layout>
    <x-slot name="pageTitle">Edit Student</x-slot>
    <x-slot name="breadcrumb">Students / Edit</x-slot>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="phone" id="phone"
                            ...
                            value="{{ old('phone', $student->user->phone) }}" placeholder="e.g., 09123456789">
                        @error('phone')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <select name="year_level" id="year_level"
                            ...
                            <option value="1"
                                {{ old('year_level', $student->year_level) == 1 ? 'selected' : '' }}>1st Year</option>
                            <option value="2"
                                {{ old('year_level', $student->year_level) == 2 ? 'selected' : '' }}>2nd Year</option>
                            <option value="3"
                                {{ old('year_level', $student->year_level) == 3 ? 'selected' : '' }}>3rd Year</option>
                            <option value="4"
                                {{ old('year_level', $student->year_level) == 4 ? 'selected' : '' }}>4th Year</option>
                        </select>
                        @error('year_level')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <select name="status" id="status" class="form-select @error('status') is-invalid @enderror"
                            ...
                            <option value="regular"
                                {{ old('status', $student->status) == 'regular' ? 'selected' : '' }}>Regular</option>
                            <option value="irregular"
                                {{ old('status', $student->status) == 'irregular' ? 'selected' : '' }}>Irregular
                            </option>
                            <option value="probation"
                                {{ old('status', $student->status) == 'probation' ? 'selected' : '' }}>Probation
                            </option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
