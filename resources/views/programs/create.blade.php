...
<x-app-layout>
    <x-slot name="pageTitle">Create Program</x-slot>
    <x-slot name="breadcrumb">Programs / Create</x-slot>
    ...
    <div class="form-container">
        ...
        <div class="form-header">
            ...
            <p>Fill in the program details</p>
        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <input type="number" name="duration_years" id="duration_years"
                            ...
                            value="{{ old('duration_years') }}" min="1" max="10" placeholder="e.g., 4">
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <input type="number" name="duration_months" id="duration_months"
                            ...
                            value="{{ old('duration_months') }}" min="1" max="60" placeholder="e.g., 6">
