{{-- resources/views/faculty/edit.blade.php --}}
<x-app-layout>
    <x-slot name="pageTitle">Edit Faculty</x-slot>
    <x-slot name="breadcrumb">Faculty / Edit</x-slot>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="phone" id="phone"
                            ...
                            value="{{ old('phone', $faculty->user->phone) }}" placeholder="e.g., 09123456789">
                        @error('phone')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="address" id="address"
                            ...
                            value="{{ old('address', $faculty->user->address) }}">
                        @error('address')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select name="position" id="position"
                            ...
                            <option value="full_time"
                                {{ old('position', $faculty->position) == 'full_time' ? 'selected' : '' }}>Full Time
                            </option>
                            <option value="part_time"
                                {{ old('position', $faculty->position) == 'part_time' ? 'selected' : '' }}>Part Time
                            </option>
                            <option value="visiting"
                                {{ old('position', $faculty->position) == 'visiting' ? 'selected' : '' }}>Visiting
                            </option>
                        </select>
                        @error('position')
                            <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="rank" id="rank"
                            ...
                            value="{{ old('rank', $faculty->rank) }}" placeholder="e.g., Instructor, Professor">
                        @error('rank')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="number" name="max_units" id="max_units"
                            ...
                            value="{{ old('max_units', $faculty->max_units) }}" min="1" max="30"
                            required>
                        @error('max_units')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="number" name="max_preparations" id="max_preparations"
                            ...
                            value="{{ old('max_preparations', $faculty->max_preparations) }}" min="1"
                            max="10" required>
                    ...
                    @php
                        $specs = old('specializations', $faculty->specializations ?? []);
                    @endphp

                    <div class="col-12">
                        <label class="form-label">Specializations</label>
                        <input type="text" name="specializations[]" class="form-control mb-2"
                            value="{{ $specs[0] ?? '' }}" placeholder="Specialization 1">
                        <input type="text" name="specializations[]" class="form-control mb-2"
                            value="{{ $specs[1] ?? '' }}" placeholder="Specialization 2">
                        <input type="text" name="specializations[]" class="form-control"
                            value="{{ $specs[2] ?? '' }}" placeholder="Specialization 3">
                    </div>
