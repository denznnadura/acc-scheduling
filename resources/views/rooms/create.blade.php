...
<x-app-layout>
    ...
    <x-slot name="breadcrumb">Rooms / Create</x-slot>
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="code" id="code"
                            ...
                            placeholder="e.g., RM101" required>
                        @error('code')
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="text" name="floor" id="floor"
                            ...
                            placeholder="e.g., 2nd Floor" required>
                        @error('floor')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="number" name="capacity" id="capacity"
                            ...
                            value="{{ old('capacity', 40) }}" min="1" required>
                        @error('capacity')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select name="type" id="type" class="form-select @error('type') is-invalid @enderror"
                            ...
                            <option value="lecture" {{ old('type') == 'lecture' ? 'selected' : '' }}>Lecture Room
                            </option>
                            <option value="laboratory" {{ old('type') == 'laboratory' ? 'selected' : '' }}>Laboratory
                            </option>
                            <option value="computer_lab" {{ old('type') == 'computer_lab' ? 'selected' : '' }}>Computer
                                Lab</option>
