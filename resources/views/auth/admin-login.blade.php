...
<head>
    ...
    <style>
        ...
        .bg-container {
            /* Admin Theme: Deep Blue to Dark Red Gradient */
        ...
        .role-admin { color: #dc2626; } /* Red accent for Admin */
        ...
        /* Password Wrapper for Lash Icon */
        .password-wrapper {
            position: relative;
            display: flex;
            align-items: center;
        ...
        input:focus {
            border-color: #dc2626; /* Admin Red Focus */
    ...
    <div class="login-card">
        ...
        <form method="POST" action="{{ route('admin.login.submit') }}">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" value="{{ old('email') }}" placeholder="admin@acc.edu.ph" required autofocus>
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <div class="password-wrapper">
                    ...
                    <button type="button" class="toggle-password" id="toggleAdminBtn">
                        <svg id="adminLashIcon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="options">
                ...
                @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}" style="color: #dc2626; text-decoration: none; font-weight: 600;">Forgot Password?</a>
                @endif
            </div>
...
<script>
    ...
    const adminLashIcon = document.getElementById('adminLashIcon');
    ...
    toggleAdminBtn.addEventListener('click', () => {
        ...
        adminLashIcon.innerHTML = isPass ? lashVisibleSVG : lashHiddenSVG;
    });
</script>
</body>
</html>