...
<x-app-layout>
    <x-slot name="pageTitle">Create Department</x-slot>
    <x-slot name="breadcrumb">Departments / Create</x-slot>
    ...
    <div class="form-container">
        ...
        <div class="form-header">
            ...
            <p>Fill in the department details</p>
        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select name="type" id="type" class="form-select @error('type') is-invalid @enderror"
                            ...
                            <option value="higher_education" {{ old('type') == 'higher_education' ? 'selected' : '' }}>
                                Higher Education</option>
                            <option value="tvet" {{ old('type') == 'tvet' ? 'selected' : '' }}>TVET</option>
                        </select>
                        @error('type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
